...
# Import core modules
from .modules.Core import APP_PREFIX, InitWireguardConfigurationsList, InitRateLimits
from .modules.ConfigEnv import DASHBOARD_MODE
from .modules.DataBase import check_and_migrate_sqlite_databases
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        from .modules.DataBase.AsyncDataBaseManager import init_async_db
        await init_async_db()
        logger.info("✓ Async database manager initialized")
        
        # Database migration check (only in scale mode)
        from .modules.ConfigEnv import DASHBOARD_TYPE
        ...
        try:
            from .modules.DataBase.AsyncDataBaseManager import get_async_db_manager
...
from .routes.fastapi_main_api import router as main_api_router
