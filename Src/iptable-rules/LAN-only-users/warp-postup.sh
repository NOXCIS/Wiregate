#!/bin/bash
#
# Cloudflare Warp PostUp Script for LANP2P Zone
...
# Configuration
WIREGUARD_INTERFACE="${WIREGUARD_INTERFACE:-LANP2P}"
WARP_INTERFACE="warp"
...
ip rule add fwmark $WARP_MARK table warp priority 103 2>/dev/null || true
