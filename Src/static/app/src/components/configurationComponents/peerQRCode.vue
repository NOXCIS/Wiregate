	...
	mounted() {
		fetchGet("/api/downloadPeer/"+this.$route.params.id, {
			...
			if (res.status){
				...
				QRCode.toCanvas(document.querySelector("#qrcode"), res.data.file, options, (error) => {
			...
			<div class="m-auto modal-dialog-centered dashboardModal justify-content-center">
				<div class="card rounded-3 shadow">
					...
					<div class="card-body p-4">
						<div class="qr-container d-flex justify-content-center align-items-center" style="min-width: 300px; min-height: 300px;">
