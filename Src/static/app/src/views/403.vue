	...
	<div class="container-fluid d-flex align-items-center justify-content-center min-vh-100 position-relative">
		...
		<div class="text-center error-content">
			...
			<div class="error-message mb-4">
				<h2 class="h3 mb-3">403 Access Forbidden</h2>
					...
					<div class="col-md-8">
						<div class="card border-0 shadow-sm">
							<div class="card-body">
								...
								<p class="card-text">This resource requires specific permissions that your account doesn't have.</p>
								<ul class="list-unstyled">
									<li><i class="bi bi-check-circle text-success me-2"></i>Check if you're logged in with the correct account</li>
									<li><i class="bi bi-check-circle text-success me-2"></i>Verify your user role has the required permissions</li>
									<li><i class="bi bi-check-circle text-success me-2"></i>Contact your administrator for access</li>
								</ul>
							</div>
						</div>
					</div>
...
export default {
	...
	methods: {
		initMatrixRain() {
			...
			const getRandomText = () => {
				// Easter egg words with low probability - updated for 403 theme
				const easterEggs = ['forbidden', 'access denied', 'permission', 'unauthorized', 'blocked', 'restricted', '403', 'no access', 'denied'];
