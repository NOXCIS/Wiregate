	...
	<div class="container-fluid d-flex align-items-center justify-content-center min-vh-100 position-relative">
		...
		<div class="text-center error-content">
			...
			<div class="error-message mb-4">
				<h2 class="h3 mb-3">401 Unauthorized Access</h2>
				<p class="mb-0">You need to authenticate to access this resource</p>
			</div>
					...
					<div class="col-md-8">
						<div class="card border-0 shadow-sm">
							<div class="card-body">
								...
								<p class="card-text">This resource requires valid authentication credentials. Please log in to continue.</p>
								<ul class="list-unstyled">
									<li><i class="bi bi-check-circle text-success me-2"></i>Check your login credentials</li>
									<li><i class="bi bi-check-circle text-success me-2"></i>Ensure your session hasn't expired</li>
									<li><i class="bi bi-check-circle text-success me-2"></i>Contact support if issues persist</li>
								</ul>
							</div>
						</div>
					</div>
...
export default {
	...
	methods: {
		initMatrixRain() {
			...
			const getRandomText = () => {
				// Easter egg words with low probability - updated for 401 theme
				const easterEggs = ['unauthorized', 'access denied', 'login required', 'auth', 'credentials', 'session', 'token', '401', 'forbidden'];
